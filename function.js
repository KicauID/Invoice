window.function = function (html, fileName, format, zoom, orientation, margin, breakBefore, breakAfter, breakAvoid, fidelity, customDimensions) {
    ...
    format = format.value ?? "thermal_80mm"; // Changed format to thermal_80mm
    zoom = zoom.value ?? "1";
    ...
    button#print { /* Changed text to 'CETAK' */
      background: #0353A7;
      right: 0;
    }
    ...
    <div class="main">
      ...
      <button class="button" id="print">CETAK</button> <!-- Changed text to 'CETAK' -->
    ...
    <script>
      ...
      document.getElementById('print').addEventListener('click', function() { /* Changed id to 'print' */
        var element = document.getElementById('content');
        var button = this;
        ...
        html2pdf().set(opt).from(element).toPdf().get('pdf').then(function(pdf) {
          ...
          button.className = 'done';
          setTimeout(function() { 
            button.innerText = 'CETAK'; /* Changed text to 'CETAK' */
            button.className = ''; 
          }, 2000);
        });
      });
